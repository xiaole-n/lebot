<?php /*a:3:{s:57:"D:\Desktop\x\php\ThinkPHP\app\index\view\index\index.html";i:1732863182;s:58:"D:\Desktop\x\php\ThinkPHP\app\index\view\index\layout.html";i:1731324274;s:56:"D:\Desktop\x\php\ThinkPHP\app\index\view\index\head.html";i:1733290685;}*/ ?>
<?php 
// 检查是否存在 PJAX 请求头
    ...
    <div class="col-6 col-xl-3">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-primary"><?php echo htmlentities($receivedMessages); ?></div>
                    <div class="fs-sm fw-semibold text-uppercase text-muted">接收数量</div>
                </div>
            </div>
        </a>
    </div>
    <div class="col-6 col-xl-3">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-earth"><?php echo htmlentities($sentMessages); ?></div>
                    <div class="fs-sm fw-semibold text-uppercase text-muted">发送数量</div>
                </div>
            </div>
        </a>
    </div>
    <div class="col-6 col-xl-3">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-elegance"><?php echo htmlentities($accountCount); ?></div>
    ...
    <div class="col-6 col-xl-3">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-pulse"><?php echo htmlentities($userCount); ?></div>
                    <div class="fs-sm fw-semibold text-uppercase text-muted">累计用户</div>
                </div>
            </div>
        </a>
    </div>
