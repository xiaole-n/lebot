<?php /*a:1:{s:57:"D:\Desktop\x\php\ThinkPHP\app\index\view\index\login.html";i:1731304984;}*/ ?>
                ...
                <div class="hero-static col-lg-6 col-xl-4">
                    <div class="content content-full overflow-hidden">
                        <div class="py-4 text-center">
                            <a class="link-fx fw-bold" href="/index/index/index.html">
                                <i class="fa fa-fire"></i>
                                <span class="fs-4 text-body-color">乐助手</span>
                            </a>
                            ...
                            <div class="block block-themed block-rounded block-fx-shadow">
                                ...
                                <div class="block-content block-content-full bg-body-light text-center d-flex justify-content-between">
                                    <a class="fs-sm fw-medium link-fx text-muted me-2 mb-1 d-inline-block"
                                       href="/index/login/reg.html">
                                        <i class="fa fa-plus opacity-50 me-1"></i> 创建账户
                                    </a>
                                    <a class="fs-sm fw-medium link-fx text-muted me-2 mb-1 d-inline-block"
                                       href="/index/login/qqLogin.html">
                                        QQ登录
                                    </a>
                                    <a class="fs-sm fw-medium link-fx text-muted me-2 mb-1 d-inline-block"
                                       href="/index/login/find.html">
                                        忘记密码?
                                    </a>
                                </div>
                            </div>
    ...
    function ajax_user_login() {
        x.ajax('/index/LoginAjax/login', {
            ...
            if (data.code == 1) {
                ...
                setTimeout(function () {
                    window.location.href = "/index/console/index.html";
                }, 1000)
